...
Уровни 1–6: +40% / +90% / +120% / +150% / +190% / +233% к базовому XP pickup radius; при базовом 0.5 units это 0.7 → 1.665 units; L6 в полтора раза меньше прежних 2.5 units ([DECISION-0055](decisions/0055-playtest-2026-09-24-fixes.md), [DECISION-0059](decisions/0059-playtest-2026-09-25-evening-fixes.md)).
...
### Ranged / особое: очередь из 3 быстрых стрел по 7 damage с интервалом 0.18 s, каждая со случайным отклонением в пределах ±6° от текущего прицела; cooldown 2.0 с ([DECISION-0055](decisions/0055-playtest-2026-09-24-fixes.md), по отзыву плейтеста). Baseline v1: дистанция 6±0.5, windup 0.45 s, speed 6.5, lifetime 1.5, radius 0.10; цикл 2 s удержания + 1 s касательного смещения (strength 0.5, знак меняется каждый цикл).
...
### Поведение: служебная гончая охотников обычно движется умеренно; каждые несколько секунд делает короткий прямой рывок к позиции гоблина, зафиксированной в момент старта. Baseline v1: telegraph 0.55 s → dash 0.55 s на speed×3.2 → recovery 2.5 s; первый dash через 2.5 s после spawn ([DECISION-0055](decisions/0055-playtest-2026-09-24-fixes.md): рывки чаще по отзыву плейтеста).
...
### Телепорт ([DECISION-0059](decisions/0059-playtest-2026-09-25-evening-fixes.md)): если игрок дольше 5 s непрерывно дальше 5 units (половина экрана), на земле в случайной точке окружности радиусом 2.2 units вокруг игрока на 0.6 s появляется предупреждающий круг радиусом 2.6; затем босс переносится в эту точку и бьёт по кругу — 20 damage, отталкивание 0.5. Стоящего игрока удар немного цепляет, отошедший из круга уворачивается.
