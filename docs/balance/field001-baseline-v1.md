...
| XP pickup radius / lifetime | 0.5 units / 60 s | За опытом нужно возвращаться, но есть время на обход |
...
| ENEMY-005 Лучник | 56 | 1.10 | 9 / 3 | Distance 6±0.5; projectile 14 damage каждые 2.0 s; смена позиции |
| ENEMY-007 Гончая | 64 | 1.55 | 14 / 4 | Telegraph 0.55 s → dash 0.55 s на speed×3.2 → recovery 4.5 s |
...
без pierce/explosion/slow. Стрелок продолжает движение во время windup.
...
4.5 s после spawn; дистанция рывка 1.55×3.2×0.55=2.728. Contact и dash используют один
