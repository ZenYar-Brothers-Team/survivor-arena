...
IP-07, IP-10, IP-16, IP-25. Production content screens используют только approved IDs.

## Scope

Character/field selection; HUD HP/XP/level/timer/build/sets; level-up chooser; reroll/banish controls; pause; result; meta currency/unlocks/upgrades.
