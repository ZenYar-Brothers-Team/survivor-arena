...
Last repository audit: 2026-09-25 (исправления по плейтестам 2026-09-24, Unity NOT RUN — нужен `check_project.py --scope full`; до этого: F1-00…08 Verified; FIELD-001 art принят пользователем — Unity 709/709 EditMode, 26/26 PlayMode; F1-09 Blocked до полной матрицы прогона)
