    ...
    public sealed class MetaProgressionSmokeTests
    {
        [UnityTest] public IEnumerator Result_Purchase_Retry_AppliesUpgradeAndKeepsOneReward()
        {
            ...
            try
            {
                ...
                Submit(root.ProfileDocument.rootVisualElement.Q<Button>(GameplayUiElementIds.MetaQuit));
                yield return null;
                ...
                Submit(root.ProfileDocument.rootVisualElement.Q<Button>(GameplayUiElementIds.MetaOpen));yield return null;
                ...
                Assert.AreEqual(1,root.Profile.Level("META-001"));Assert.AreEqual(baseHp,player.Stats.MaxHealth);
