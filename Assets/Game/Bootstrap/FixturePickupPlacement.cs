...
namespace Game.Bootstrap
{
    ...
    {
        public static IPickupPlacement Create(FieldEnvironmentDefinition environment, Scene scene, Collider2D player, float skin)
        {
            ...
            return new BoxPickupPlacement(arena, obstacles, player.bounds.extents, spawn.position, skin);
        }
    }
}
